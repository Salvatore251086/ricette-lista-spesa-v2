// script/adapters/lacucinaitaliana.cjs
...
async function parseLaCucinaItaliana(url) {
  if (!url) throw new Error("URL mancante per La Cucina Italiana")
...
module.exports = { parseLaCucinaItaliana }
